...
pc.pattern('/Users/ashton/Internship/AutoCellTester/dtm/1.dtm')
h.capCam('1.dtm')
pt1, pt2, pt3, pt4 = h.getCooCrop()


# Detect pin's status for every pattern
folderPath = '/Users/ashton/Internship/AutoCellTester/dtm/'
file_list = os.listdir(folderPath)

for fileName in file_list:
    pc.pattern('/Users/ashton/Internship/AutoCellTester/dtm/' + fileName)
    h.capCam(fileName)
